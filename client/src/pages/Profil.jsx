...
function Profil(props) {
    ...
    const loadPost = async () => {
        let { data } = await axios.get(`/get-user-post/${state?.data?._id}`);
        setPost(data)
    }
    useEffect(() => {
        loadPost()
    ...
    async function deletePost(id){
        let { data } = await axios.delete(`/delete-post/${id}`)
        ...
        <div className='pr_page'>
            <div className="pr_quti">
                <div className="pr_text">
                    ...
                    <button className='btn pr_btn' onClick={() => navigate('/user/edit-profil')}>Edit Profil</button>
                </div>
                <div className='pr_quti1'>
                    ...
                    <div className='pr_quti2'>
                        <div className='pr_quti3'>
                            <h6>{state?.data?.followers.length}</h6>
                            <p>Followers</p>
                        </div>
                        <div className='pr_quti3'>
                            <h6>{post.length}</h6>
                            ...
                            return (
                                <div className="hm_card card" style={{ width: '18rem' }} key={idx}>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <button className='btn ep_btn mt-4 w-100' onClick={()=>deletePost(s._id)}>Delete</button>
                                    </div>
                                </div>
                            )
                        })
